 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_s' ) ) {
	function azrcrv_create_plugin_menu_s() {
		azrcrv_populate_plugin_menu_s();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_s' ) ) {
	function azrcrv_populate_plugin_menu_s() {
